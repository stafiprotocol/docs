...
Cosmos rToken and FIS bridge, we recommend using the IBC functionality of the Keplr wallet. StaFi Hub has been successfully integrated into the Keplr wallet. You can check the [Kpler help doc](https://help.keplr.app/articles/ibc-transfers).
