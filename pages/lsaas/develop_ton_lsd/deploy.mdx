...
Link to your wallet, such as Tonkepper, for follow-up actions 

![image-20241015153325385](./assets/image-20241015153325385.png)

![image-20241015152245555](./assets/image-20241015152245555.png)
...
```bash
$ ton-lsd-relay start --global_config_url=https://ton.org/testnet-global.config.json --stake_pool=kQBIEjXuvFC0CEnE_69iM7DiPOspfcX25pJxPKERKs8k8xvJ
StakePool: kQBIEjXuvFC0CEnE_69iM7DiPOspfcX25pJxPKERKs8k8xvJ
