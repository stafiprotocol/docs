...
[rAsset](https://app.stafi.io/rasset) is a dashboard product for rToken holders. It allows rToken holders to manage their rToken assets, including the amount of rTokens in their wallet, the total value of their held rTokens, and the number of redeemable native tokens.
