...
<Callout type="info">
Mining rETH is currently only supported on Ethereum Layer1. If you wish to participate in liquidity mining or other on-chain activities on layer2, you will need to bridge your rETH from Layer1 to Layer2. You can check the [bridge guides](/bridge).
</Callout>
