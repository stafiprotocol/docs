...
![StaFi Stake ATOM](/image/stakingunstakingcosmosatom_1.png)

### 2. Connect Wallet

Click on the “Connect Wallet” button to connect your Keplr wallet.

![StaFi Stake ATOM](/image/stakingunstakingcosmosatom_2.png)

### 3. Visit rATOM Dashboard

Click the "Stake" button to access the [rATOM Dashboard](https://app.stafi.io/gallery/cosmos/ATOM).

![StaFi Stake ATOM](/image/stakingunstakingcosmosatom_3.png)
...
Note: The minimum staking amount required is XXX ATOM.
...
Monitor your staked ATOM and its rewards by visiting your **[Profile](https://test-app.stafi.io/profile/evm?net=BEP20)**.
...
### 1. **Visit rATOM Dashboard**

Visit the [rATOM Dashboard](https://app.stafi.io/gallery/cosmos/ATOM), and proceed by clicking on the "Unstake" tab.
