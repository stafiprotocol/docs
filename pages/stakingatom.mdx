...
## Liquid Staking Guide for Staked ATOM
...
### Input the Amount of staked ATOM

On the "Liquid Stake" page, select "Staked ATOM" and enter the amount of staked ATOM you want to liquid stake. Then click on "Liquid stake 5 Staked ATOM".
