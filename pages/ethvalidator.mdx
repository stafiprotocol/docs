...
StaFi ETH staking supports two types of validators: solo validators and trust validators. Solo validators are permissionless, which means that anyone can deposit 4 ETH and run a node to become a solo validator.
...
Go to the [ETH staking  validator page](https://app.stafi.io/validator/reth/choose-validator) and select solo validator.
