...
### Go to HUHUA staking page

Click the "Stake" button to access the [HUAHUA staking page](https://app.stafi.io/gallery/cosmos/HUAHUA).
...
### Go to HUAHUA unstaking page

Visit the [HUAHUA unstaking page](https://app.stafi.io/gallery/cosmos/HUAHUA?tab=unstake), and proceed by clicking on the "Unstake" tab.
