...
Click the "Stake" button to access the [KSM staking page](https://app.stafi.io/gallery/polkadot/KSM?tab=stake&net=StaFi&srcTokenStandard=Native&dstTokenStandard=ERC20).
...
Visit the [KSM unstaking page](https://app.stafi.io/gallery/polkadot/KSM), and proceed by clicking on the "Unstake" tab.
