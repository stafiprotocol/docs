...
### Visit rKSM Dashboard

Click the "Stake" button to access the [KSM Dashboard](https://app.stafi.io/gallery/polkadot/KSM?tab=stake&net=StaFi&srcTokenStandard=Native&dstTokenStandard=ERC20).
...
Visit the [KSM Dashboard](https://app.stafi.io/gallery/polkadot/KSM), and proceed by clicking on the "Unstake" tab.
